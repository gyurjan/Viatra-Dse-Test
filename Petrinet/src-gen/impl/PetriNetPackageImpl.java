...
public class PetriNetPackageImpl extends EPackageImpl implements PetriNetPackage {
	...
	public void initializePackageContents() {
		...
		initEReference(getTransition_Input(), this.getPlace(), null, "input", null, 0, -1, Transition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
